    ...
    <div id='about' className={styles.container}>
      ...
      <div className={styles.about}>
        ...
        <div className={styles.box}>
          <p>
            I&apos;m an innovative Solution Designer &amp; Technical Architect at Unifiedpost gathering requirements,
            creating functional and solution specifications, assessing the current software systems in place in order to
            identify areas in need of improvement, and assisting a development team.
          </p>
          ...
          <ul>
            ...
            <li>
              Specify how the application will work, what the modules will be used, and how they interact with each
              other.
            </li>
            ...
            <li>
              Informing various stakeholders (PO, BA, Delivery Manager) about any problems with the current technical
